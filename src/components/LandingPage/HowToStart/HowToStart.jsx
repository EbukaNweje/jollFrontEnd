    ...
    <main className="main2">
      <div className="mainwrap">
        <div className="mainHeader">
          <h2>How To Start?</h2>
          <p>
            Crypto trading is exciting if you’re with the Okxcryptofield
          ...
          <div className="stepsInfo2">
            <div className="stepsInfoBox">
              <div className="stepsInfoBoxText">
                <p>Start with Okxcryptofield</p>
                <p className="CryptoInfo">
                  Your crypto journey starts with Okxcryptofield, so grab the bull by
